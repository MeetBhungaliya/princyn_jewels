...
export default async function page() {
  ...
  return (
    <>
      <Carousel banners={banners.map((banner) => ({ id: banner.id, desktopImageUrl: banner.desktopImage, mobileImageUrl: banner.mobileImage, altText: banner.title || "Princyn Jewels promotion", link: banner.link || undefined }))} />
      <PromoSection />
